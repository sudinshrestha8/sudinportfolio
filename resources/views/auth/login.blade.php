...
<head>
    ...
    <title>Sign in — {{ $settings->site_title ?? 'Portfolio' }}</title>
    ...
    <div class="relative min-h-screen flex flex-col">
        ...
        <main class="flex-1 flex items-center justify-center px-4 py-12">
            <div class="w-full max-w-sm animate-fade-in-up">
                ...
                {{-- Error --}}
                @if ($errors->any())
                    <div class="mb-6 flex items-start gap-3 px-4 py-3.5 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50">
                ...
                <form method="POST" action="{{ route('login.attempt') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-4 py-2.5 text-sm bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-2 transition-all duration-200"
                            style="--tw-ring-color: var(--color-accent); focus:ring-[var(--color-accent)]"
                    ...
                    <div class="flex items-center gap-2.5">
                        <input
                            ...
                            name="remember"
                            value="1"
                            class="w-4 h-4 rounded border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 cursor-pointer"
                            style="accent-color: var(--color-accent)"
                        >
                        <label for="remember" class="text-sm text-gray-500 dark:text-gray-400 cursor-pointer select-none">
                            Remember me
                        </label>
                    </div>
