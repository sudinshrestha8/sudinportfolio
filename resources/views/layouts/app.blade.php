                    ...
                    @auth
                        <div class="hidden md:flex items-center gap-2" x-data="{ open: false }">
                            <button @click="open = !open"
                                    class="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-200 text-sm font-medium"
                                    id="user-menu-btn">
                            ...
                            <div x-show="open"
                                 ...
                                 class="absolute top-14 right-4 z-50 w-44 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-xl overflow-hidden"
                                 style="display:none">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <button type="submit"
                                            id="logout-btn"
                                            class="w-full flex items-center gap-2 px-4 py-3 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-150">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    @auth
                        <div class="pt-2 border-t border-gray-100 dark:border-gray-800 mt-1">
                            <p class="px-3 py-1 text-xs text-gray-500 dark:text-gray-400">{{ auth()->user()->email }}</p>
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="w-full text-left px-3 py-2 text-sm font-medium rounded-lg text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 flex items-center gap-2">
                    ...
                    @else
                        <div class="pt-2 border-t border-gray-100 dark:border-gray-800 mt-1">
                            <a href="{{ route('login') }}" class="flex items-center gap-2 px-3 py-2 text-sm font-semibold rounded-lg text-white transition-colors duration-200" style="background: var(--color-accent)">
